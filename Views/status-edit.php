<?php 
    ...
    if($_POST['r'] == 'status-edit' && $_SESSION['role_u'] == 'Admin' && !isset($_POST['crud'])) {
       ...
       if(empty($status)) {
        ...
        $template_status = '<h2 class="p1">Editar Status</h2>
    ...
    } else if ($_POST['r'] == 'status-edit' && $_SESSION['role_u'] == 'Admin' && $_POST['crud'] == 'set') {
        ...
        $template = '
                    <div class="container">
                        <p class="item add">Status <b>%s</b> fue editado</p>
                    </div>
                    <script>
